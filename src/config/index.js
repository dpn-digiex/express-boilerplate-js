...
export const MongoURL = process.env.MONGO_URL || "mongodb+srv://duyphong-admin:NxHUEKkEk8l0SX0f@cluster0.ph4pq.mongodb.net/create-express-server?retryWrites=true&w=majority";
